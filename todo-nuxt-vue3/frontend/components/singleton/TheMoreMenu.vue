<template>
  <div>
    ...
    <div v-if="open" class="absolute right-2 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
      <div class="flex items-center block px-4 py-2 mb-2 text-sm text-gray-700 border-b border-gray-200">
        <p class="mr-1">
          Signed in as
        </p>
